...
from BinaryJax import contour_integral,to_centroid,to_lowmass
...
x    Parameters:
    ...
    Jax_mag=[]
    ## compile time
    mag=contour_integral(z_lowmass[0],retol,retol,rho,s,q,default_strategy=(60,240,480))[0]
    ## real time
    start=time.time()
    for i in range(trajectory_n):
        mag=contour_integral(z_lowmass[i],retol,retol,rho,s,q,default_strategy=(60,240,480))[0]
        Jax_mag.append(mag)
