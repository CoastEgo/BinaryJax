...
def mag_gen_jax(i):#t_0,b_map,t_E,rho,q,s,alphadeg,times_jax,tol,
    ...
    uniform_mag,cond=point_mag_jax(t_0,b_map[i],t_E,rho,q,s,alphadeg,times_jax,tol)
...
tol=1e-3;retol=0.
t_0=8283.594505;t_E=42.824343
times=np.linspace(t_0-1.*t_E,t_0+1.0*t_E,trajectory_n);alphadeg=270
...
# vbbl time
start = time.perf_counter()
mag_gen_vbbl = lambda i : VBBL_light_curve(t_0,b_map[i],t_E,rho,q,s,alphadeg,times,retol,tol)
